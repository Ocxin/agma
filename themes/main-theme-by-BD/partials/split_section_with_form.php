...
<?php if (get_sub_field('visible')) : ?>
    <section id="split-section-with-form" class="mardello_section split-section-with-form py-5"  
    ...
    >
        <div class="container">
            ...
            <div class="col-md-12 col-lg-6">
                    <div class="split-section-with-form__contact">
                    <?php if(get_sub_field('title')):?>
                        <h1 class="split-section-with-form__contact__heading mb-5"><?php echo get_sub_field('title');?></h1>
                        <?php endif;?>
                        <?php $form_string = '[contact-form-7 id="'.get_sub_field('form_id').'"  ]';?>
